class TextMessage {
	...
	createElement() {
		...
		this.element.innerHTML = `
			...
			<div id="TextMessage_bg" style="left: 0px; bottom: 28px; position: absolute"><img draggable="false" src="https://raw.githubusercontent.com/AFShiva/Project-X/main/images/Textground/${this.background}.png"></div>
			<div id="TextMessage_fg" style="left: 0px; bottom: -4px; position: absolute"> <img draggable="false" src="https://raw.githubusercontent.com/AFShiva/Project-X/main/images/Textground/${this.forground}.png"></div>
